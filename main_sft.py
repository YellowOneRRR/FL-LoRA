...
# ===== Load the dataset =====
dataset = Dataset.load_from_disk(dataset_path="../transformers-code/03-PEFT/data/alpaca_data_zh")
...
tokenizer = AutoTokenizer.from_pretrained(script_args.model_name_or_path, use_fast=True, padding_side="right")
